...
public class AdapterInvoiceLine extends RealmRecyclerViewAdapter<Line, RecyclerView.ViewHolder> {
    ...
    public AdapterInvoiceLine(Context context, OrderedRealmCollection<Line> realmResults, Integer invoiceType, int viewType) {
